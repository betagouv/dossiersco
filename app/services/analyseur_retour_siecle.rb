class AnalyseurRetourSiecle
  ...
  def self.analyse(dossier)
    ...
    return I18n.t("retour_siecles.dossier_sans_nom_ou_prenom") unless dossier.eleve.nom.present?
    return I18n.t("retour_siecles.probleme_commune_naissance") unless dossier.eleve.pays_naiss == "100" && dossier.eleve.commune_insee_naissance.present?
