  ...
  class PiecesAttenduesController < ApplicationController
    ...
    def create
      ...
      if @piece_attendue.save
        redirect_to configuration_pieces_attendue_index_url, notice: 'Piece attendue was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      if @piece_attendue.update(piece_attendue_params)
        redirect_to configuration_mef_index_url, notice: 'Piece attendue was successfully updated.'
      else
        render :edit
      end
    end
    ...
    def destroy
      ...
      redirect_to configuration_mef_index_url, notice: 'Piece attendue was successfully destroyed.'
    end
