...
class FamilleMailerTest < ActionMailer::TestCase
  ...
  test "contacter_une_famille" do
    ...
    dossier_eleve = Fabricate(:dossier_eleve, eleve: eleve, etablissement: etablissement, resp_legal: [resp_legal])
  ...
  test "envoyer mail confirmation" do
    ...
    assert_equal [etablissement.email_chef].sort, email.reply_to.sort
