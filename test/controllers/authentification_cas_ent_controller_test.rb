...
class AuthentificationCasEntControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'retour fichier XML' do
    ...
    resp_legal = Fabricate(:resp_legal, nom: 'FORD', prenom: 'Henri', adresse: '533 RUE DU TEST', email: 'henri@ford.com')
    eleve = Fabricate(:eleve, prenom: 'Mustang', nom: 'FORD')
    dossier_eleve = Fabricate(:dossier_eleve, etablissement: etablissement, resp_legal: [resp_legal], eleve: eleve)
