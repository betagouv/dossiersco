def init
  ...
  Agent.create!(password: '$2a$10$6njb4Rn4RHyFFJpP5QEJGutErgZVOr6/cCM17IKoIsiQDZQABBN2a', nom: 'César', prenom: 'Jules', etablissement_id: oeben.id, identifiant: 'jules')
  ...
  Agent.create!(password: 'demaulmont', nom: 'De Maulmont', prenom: 'Pierre', etablissement_id: tillion.id, identifiant: 'pierre', admin: true)
end
